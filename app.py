...
pusher = Pusher(app_id=u'1322267', key=u'83e05e817b8fdb26f54b', secret=u'fe70575c9c3b71181fab', cluster=u'eu')
...
def getAnalyticsData():
    ...
    userIP = "41.233.116.6" if request.remote_addr == '127.0.0.1' else request.remote_addr
